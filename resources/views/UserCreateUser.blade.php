        ...
        <div class="dashboard-parent3" id="frameContainer">
            ...
            @csrf
                <div class="nama-user6">
                    <div class="last-name3">
                        <!-- <div class="last-name-child1"></div>
            <b class="last-name4">Last Name</b> -->
                        <input type="text" class="last-name-child1" placeholder="Last Name" name="last_name" >
                    </div>
                    <div class="first-name3">
                        <!-- <div class="last-name-child1"></div>
            <b class="emailexamplecom">First Name</b> -->
                        <input type="text" class="last-name-child1" placeholder="Frist Name" name="frist_name">
                    </div>
            ...
            <b class="emailexamplecom">102752732364</b> -->
                        <input type="text" class="email-child1" placeholder="102752732364" name="nip">
                    </div>
            ...
            <b class="masukkan-kantor-cabang">Masukkan Kantor Cabang</b> -->
                        <input type="text" class="email-child1" placeholder="Masukkan Kantor Cabang" name="kantor_cabang">
                    </div>
                ...
                <div class="role6" >
                    ...
                    <input type="checkbox" class="role-child2" name="role" value="User">
                    <!-- <div class="role-child3" id="rectangle7"></div> -->
                    <input type="checkbox" class="role-child3"name="role"  value="Super Admin">
                    <div class="user24">User</div>
                    <div class="super-admin5">Super Admin</div>
                </div>
                <div class="confirm4">
                    <div class="confirm-item"></div>
                    <button class="confirm-item">Confirm</button>
                    <!-- <b class="confirm5"></b> -->
                </div>
                <a href="/User"><img class="go-back-icon3" alt="" src="img/go-back@2x.png" /></a>
        </div>
        </form>
