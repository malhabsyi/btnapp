    ...
    <div class="overview-kantor-cabang-5">
        <div class="dashboard-group">
            <div class="dashboard3">
                <b class="overview-kantor-cabang6">Overview Kantor Cabang {{$data->kantor_cabang_name}}</b><b
                    class="overview-kantor-cabang7">Overview Kantor Cabang</b>
            </div>
            <div class="overview-outlet3">
                <div class="overview-outlet-child1"></div>
                <a href="/view/{{$data->id}}"><div class="edit3">Edit</div></a>
                ...
                <table class="nama-outlet9">
                    ...
                    <tbody>
                        <tr>
                            <td class="kantor-cabang-mulyosari3">{{$data->kantor_cabang_name}}</td>
                        </tr>
                    </tbody>
                ...
                <table class="alamat6">
                    ...
                    <tbody>
                        <td class="kantor-cabang-mulyosari3">{{$data->kantor_cabang_location}}</td>
                    </tbody>
                ...
                <table class="jumlah-mesin3">
                    ...
                    <tbody>
                        <td class="kantor-cabang-mulyosari3">3 outlet</td>
                    </tbody>
                ...
                <table class="status15">
                    ...
                    <tbody>
                        <td class="kantor-cabang-mulyosari3">{{$data->jumlah_mesin}}</td>
                    </tbody>
                ...
                <table class="catatan6">
                    ...
                    <tbody>
                        <td class="catatan-child1">{{$data->catatan}}</td>
                    </tbody>
        ...
        <div class="hello3">
            ...
            <b class="hello-ananda-segaf3">Hello, {{ auth()->user()->frist_name}}</b><img class="customer-icon3" alt=""
