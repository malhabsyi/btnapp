...
<head>
    ...
    <link rel="stylesheet" href="../css/KantorCabangCreate.css" />
...
<body>
    <div class="user-create-user-2">
        <div class="dashboard-parent">
            <div class="dashboard">
                <b class="form-pembuatan-user">Form Pembuatan User pada Kantor Wilayah III</b><b
                    class="create-user">Edit Kantor Cabang</b>
            </div>
            <div class="nama-user">
                <!-- <div class="last-name">
                ...
                <form action="/update-kantorcabang/{{$kantorcabang->id}}" method="post">
                    @csrf
                    @method('put')
                    ...
                    <b class="naufal">Naufal</b> -->
                        <input type="text" class="email-child" placeholder="" name="kantor_cabang_name"
                            value="{{$kantorcabang->kantor_cabang_name}}">
                    </div>
                    <b class="nip">Nama Kantor <br> Cabang</b>
            </div>
            <div class="email">
                <div class="email1">
                    ...
                    <input type="text" class="email-child" placeholder="" name="kantor_cabang_location"
                        value="{{$kantorcabang->kantor_cabang_location}}">
                </div>
                <b class="nip">Alamat</b>
            </div>
            <div class="password">
                <div class="password1">
                    <!-- <div class="email-child"></div>
            ...
            <div class="re-enter-password">
                <div class="password3">
                    ...
                    <input type="text" class="email-child" placeholder="" name="status" value="{{$kantorcabang->status}}">
                </div>
                <b class="nip">SBH Kantor Cabang</b>
            </div>
            <div class="kantor-cabang">
                <div class="password4">
                    <div class="email-child"></div>
                    <b class="kc-unair">KC Unair</b>
                    <input type="text" class="email-child" name="catatan" value="{{$kantorcabang->catatan}}">
                </div>
                <b class="nip" style="left: 103px;">Catatan</b>
            </div>

            <!-- 
            <div class="role">
                <b class="role1">Catatan</b>
                <div class="role-child" id="rectangle6"></div>
             <div class="role-item" id="rectangle7"></div> 
                <input type="text" class="role-child" name="catatan">
        ...
        <a href="/overview-kantorcabang/{{$kantorcabang->id}}"><img class="go-back-icon" alt="" src="../img/go-back@2x.png" /></a>
    </div>
    <div class="hello">
        <div class="hello-child"></div>
        <b class="hello-ananda-segaf">Hello, Ananda Segaf</b><img class="customer-icon" alt=""
