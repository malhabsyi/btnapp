    ...
    <div class="user-create-user-2">
        <div class="dashboard-parent">
            ...
            <div class="nama-user">
                ...
                <form action="/updateKantorCabang/{{$data->id}}" method="post">
                    @csrf
                    @method('put')
            ...
            <div class="email">
                <div class="email1">
                    ...
                    <input type="text" class="email-child" placeholder="" name="kantor_cabang_location"
                        value="{{$data->kantor_cabang_location}}">
                </div>
            ...
            <div class="re-enter-password">
                <div class="password3">
                    ...
                    <input type="text" class="email-child" placeholder="" name="status" value="{{$data->status}}">
                </div>
            ...
            <div class="kantor-cabang">
                <div class="password4">
                    ...
                    <input type="text" class="email-child" name="catatan" value="{{$data->catatan}}">
                </div>
