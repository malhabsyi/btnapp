        ...
        <div class="dashboard-container">
                    ...
                    <table class="outlet-12">
                        ...
                        <thead>
                            ...
                            <th style="border-right: 1px  solid var(--color-tan);
                                border-left: 1px solid var(--color-tan);">Jumlah Mesin</th>
                            <th>Status</th>
                            <th></th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                border-left: 1px solid var(--color-tan);">{{$o->jumlah_mesin}}</td>
                                <td class="milik-perusahaan5">{{$o->status}} </td>
                                <td></td>

                                <td><a href="/OverviewKantorCabang/{{$o->id}}"><img style="width:40px;" alt=""
            ...
            <a href="/OutletCreate">
                <div class="create-user">
                    <button class="create-user-child"></button>
                    <b class="create-outlet">Create Outlet</b><img class="add-icon" alt="" src="img/add@2x.png" />
                </div>
            </a>
            <div class="search">
